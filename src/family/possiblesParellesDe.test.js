...
import {possiblesParellesDe} from './FamilyForm';


export const aLargeFamily = Map({
...
describe('Find Partners', () => {
      it('Detects the partner of the person who is in front of the computer', () => {
        expect(
            possiblesParellesDe(aLargeFamily.get('fd2adda9-5928-49f9-a5b8-3f601b7d9ab8'), aLargeFamily.toArray())
        ).toEqual(
            [
              {
                is_the_person_in_front_of_the_computer: false,
      ...
      it('Detects the partner of a parent', () => {
        expect(
            possiblesParellesDe(aLargeFamily.get('91f9d921-a3fc-4b49-a994-2c8d25d61f3f'), aLargeFamily.toArray())
        ).toEqual(
            [
              {
                is_the_person_in_front_of_the_computer: false,
