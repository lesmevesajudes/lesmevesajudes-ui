...
export const PersonCard = withWidth()(withNamespaces("translations")((props: PersonCardProps) => {
  ...
  const secondaryText = person.edat != null ? <Trans i18nKey='descripcio_persona' nom={edat} rol_traduit={rol_traduit}
                                                     el_teu_traduit={el_teu_traduit}>{{edat}} anys
    és {{el_teu_traduit}} {{rol_traduit}}</Trans> : "";
