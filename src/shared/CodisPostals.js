...
export function esBarcelona(codiPostal: string) {
    ...
    return (codiPostalNum >= 8001 && codiPostalNum <= 8042 )
        || codiPostalNum === 8196 || codiPostalNum === 8830
        || codiPostalNum === 8903 || codiPostalNum === 8904
        || codiPostalNum === 8930 || codiPostalNum === 8960 ;
}
...
export function esCatalunya(codipostal: string) {
    ...
    return dosPrimersDigits === CPBarcelona
