...
const residenceDataToAPI = (residenceData: ResidenceData) => ({
  ...
  valor_de_patrimoni: lastYear(residenceData.valor_de_patrimoni),
...
const personToOpenFiscaPerson = (person: Person) => ({
  ...
  grau_dependencia: currentMonth(person.grau_dependencia),
  ...
  esta_o_ha_estat_en_erto: currentMonth(person.es_troba_en_erto),
