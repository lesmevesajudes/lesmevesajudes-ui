      ...
      <div className="bg-container">
        ...
        <Grid container direction={"row"} justify={"space-around"}>
              ...
              <div>
                <div>
                  <div className="field">
                    ...
                    <label>
                      <Trans>Relació amb l'habitatge</Trans>
                    </label>
                    <Field name="relacio_habitatge" component={Select} fullWidth>
                      <MenuItem value="propietari">
                        <Trans>Propietari</Trans>
                      </MenuItem>
                      <MenuItem value="llogater">
                        <Trans>Llogater</Trans>
                      </MenuItem>
                      <MenuItem value="usufructuari">
                        <Trans>Usufructuari</Trans>
                      </MenuItem>
                    </Field>
                  </div>
                  {esLlogater && (
                      <div className="field">
                        ...
                        <Field
                            ...
                            fullWidth
                        >
                          {props.personesQuePodenTenirContracteDeLloguer
                              .valueSeq()
                              .map(persona => (
                          ...
                          <MenuItem key="no-conviu" value="no-conviu">
                            Una persona que no viu a l'habitatge
                          </MenuItem>
                        </Field>
                      </div>
                  )}
                      ...
                      <div className="field">
                        <label>
                          <Field
                              ...
                              fullWidth
                          />{" "}
                          Algun membre de la família té relació de parentiu amb el
                      ...
                      <div className="field">
                        <label>
                          <Field
                              ...
                              fullWidth
                          />{" "}
                          Existeix un deute en el pagament del lloguer
                        </label>
                      </div>
                  )}
                  ...
                  {esLlogater && (
                      <div className="field">
                        <label>
                          <Field
                              name="lloguer_domiciliat"
                              component={Checkbox}
                              fullWidth
                          />{" "}
                          El pagament del lloguer està domiciliat
                        </label>
                      </div>
                  )}
                  ...
                  <div className="field">
                    <label>
                      <Field
                          ...
                          fullWidth
                      />{" "}
                      Tinc alguna propietat a part de l'habitatge habitual
                    </label>
                  </div>
                  {teAlgunaPropietat && (
                      <div className="field">
          ...
          <Grid item xs sm={5}>
            ...
            cum cupiditate esse est eum eveniet incidunt laboriosam natus neque,
            nisi non odit placeat porro quasi rem vero voluptate voluptatum!
          </Grid>
        </Grid>
      </div>
  );
...
function mapStateToProps(state) {
  return {
    ...
    teAlgunaPropietat: selector(
        state,
        "tinc_alguna_propietat_a_part_habitatge_habitual"
    ),
    initialValues: state.rent,
    personesQuePodenTenirContracteDeLloguer: state.adults.filter(
        adult => adult.rol !== "fill"
    )
  };
}
