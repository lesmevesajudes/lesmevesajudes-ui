        ...
        <header id='brand' className='v2017 lang-ca bcnbrand-legacy'>
          ...
          <div className='bcnbrand-desktop'>
            <div className='bcnbrand-navs-container'>
              <nav className='bcnbrand-shortcuts' id='bcnbrand-shortcuts-nav' aria-hidden='true'
                  ...
                  <li>
                    <a target='_blank' rel='noopener noreferrer' href='http://ajuntament.barcelona.cat'
                       tabIndex='3' title='ajuntament.barcelona.cat' data-ga='Ajuntament'>
                                    <span
                                        className='bcnbrand-icon bcn-icon-ajuntament bcnbrand-circle bcnbrand-bg-purple'/>
                      <span className='bcnbrand-link'>ajuntament.barcelona.cat</span>
                    </a>
                  </li>
                  <li>
                    <a target='_blank' rel='noopener noreferrer' href='http://meet.barcelona.cat/ca'
                       tabIndex='3' title='meet.barcelona.cat' data-ga='Meet'>
                ...
                <ul className='bcnbrand-list' aria-expanded='false'>
                  ...
                  <li>
                    <a target='_blank' rel='noopener noreferrer'
                       ...
                       tabIndex='3' title='Tràmits' data-ga='Tramits'>
                      <span className='bcnbrand-icon bcn-icon-tramits-o'/>
                      <span className='bcnbrand-link'>Tràmits</span>
                    </a>
                  </li>
                  <li>
                    <a target='_blank' rel='noopener noreferrer' href='http://barcelona.cat/planol/'
                       tabIndex='3' title='Plànol BCN' data-ga='Planol'>
                  ...
                  <li>
                    <a target='_blank' rel='noopener noreferrer'
                       href='http://ajuntament.barcelona.cat/canals-comunicacio-ciutadana/' tabIndex='3'
                       title='Canals de comunicació' data-ga='Canals'>
                  ...
                  <li>
                    <a target='_blank' rel='noopener noreferrer'
                       href='http://com-shi-va.lameva.barcelona.cat/ca/' tabIndex='3' title="Com s'hi va"
                       data-ga='Com shi va'>
                ...
                <a className='bcnbrand-close' tabIndex='4' title='Tanca' aria-label='Tanca' aria-expanded='false'
                   aria-controls='bcnbrand-shortcuts-nav' data-ga='Tanca-Drecera'>
                  <span className='bcnbrand-icon bcn-icon-tancar-light'/>
                </a>
              </nav>
              <nav className='bcnbrand-lang lang bcnbrand-lang-extended' id='bcnbrand-lang-nav' aria-hidden='true'
                   style={{maxHeight: '0px', display: 'none'}}>
                <ul className='bcnbrand-list' aria-expanded='false'>
            ...
            <div className='bcnbrand-main-container'>
              <div className='bcnbrand-main'>
                <ul className='bcnbrand-list'>
                  <li>
                    <a href='http://www.barcelona.cat/ca/' className='bcnbrand-main-link' tabIndex='1'
                       title='Barcelona' data-ga='barcelona.cat'>
                      www.barcelona.cat
                    </a>
                  </li>
                  <li>
                    <a className='bcnbrand-nav-link bcnbrand-nav-link-squares'
                       data-target='bcnbrand-shortcuts' tabIndex='2' title='Dreceres de barcelona.cat'
                  ...
                  <li>
                    <form action='https://cercador.barcelona.cat/ca'>
                      <div className='bcnbrand-input'>
                        <input className='cercabcn' type='text' name='query'
                  ...
                  <li>
                    <a className='bcnbrand-nav-link bcnbrand-nav-link-lang-selector'
                       data-target='bcnbrand-lang' tabIndex='7' title='Canviar idioma'
                       aria-label='Canviar idioma' aria-expanded='false' aria-controls='bcnbrand-lang-nav'
                       data-ga='Idioma'>
                  ...
                  <li>
                    <a target='_blank' rel='noopener noreferrer' className='bcnbrand-logo-main'
                       href='http://ajuntament.barcelona.cat/ca/' tabIndex='10' data-ga='Llima'>
