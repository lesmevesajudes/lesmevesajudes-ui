            ...
            <header id="brand" className="v2017 lang-ca bcnbrand-legacy">
                <div className="bcnbrand-desktop">
                    <div className="bcnbrand-navs-container">
                        ...
                        <nav className="bcnbrand-lang lang bcnbrand-lang-extended" id="bcnbrand-lang-nav" aria-hidden="true" style={{maxHeight: '0px', display: 'none'}}>
                            <ul className="bcnbrand-list" aria-expanded="false">
                    ...
                    <div className="bcnbrand-main-container">
                        <div className="bcnbrand-main">
                            <ul className="bcnbrand-list">
                                <li>
                                    <a href="http://www.barcelona.cat/ca/" className="bcnbrand-main-link" tabIndex="1" title="Barcelona" data-ga="barcelona.cat">
                                        www.barcelona.cat
                                    </a>
                                </li>
                                <li>
