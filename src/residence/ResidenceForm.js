              ...
              <Grid item sm={6}>
                ...
                <YesNoQuestion name='ha_perdut_lhabitatge_en_els_ultims_2_anys'>
                  <Trans>Ha perdut el seu habitatge habitual degut a una execució hipotecària o desnonament en els
                    darrers dos anys?</Trans>
                </YesNoQuestion>}

                {esLlogater && (haEstatDesnonat || haParticipatEnUnProcesDeMediacio || existeixDeutePagamentLloguer) &&
                ...
                && (haEstatDesnonat || haParticipatEnUnProcesDeMediacio || existeixDeutePagamentLloguer) &&
                ...
                {teHabitatgeHabitual
                && (haEstatDesnonat || haParticipatEnUnProcesDeMediacio || existeixDeutePagamentLloguer || existeixDeutePagamentLloguer) &&
