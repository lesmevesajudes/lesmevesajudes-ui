          ...
          <Grid container direction='row' justify='space-around' alignItems='stretch' spacing={16}>
            <Grid item sm={6}>
              ...
              <MoneyQuestion name='import_de_la_hipoteca'>
                <Trans>Quin és l'import mensual de la seva hipoteca?</Trans>
              </MoneyQuestion>}
              ...
              <YesNoQuestion name='ha_perdut_lhabitatge_en_els_ultims_2_anys'>
                <Trans>Ha perdut el seu habitatge habitual degut a una execució hipotecària o desnonament en els
                  darrers 2 anys?</Trans>
              </YesNoQuestion>}

              {(esLlogater || esCessio) && optaAAlgunAjut &&
              ...
              {existeixHipoteca && optaAAlgunAjut &&
              ...
              {teHabitatgeHabitual && optaAAlgunAjut &&
...
function mapStateToProps(state) {
  ...
  const existeixDeutePagamentLloguer = selector(state, "existeix_deute_en_el_pagament_del_lloguer");
  const existeixDeutePagamentHipoteca = selector(state, "existeix_deute_en_el_pagament_de_la_hipoteca");
  ...
  return {
    ...
    existeixDeutePagamentLloguer: existeixDeutePagamentLloguer,
    existeixDeutePagamentHipoteca: existeixDeutePagamentHipoteca,
    ...
    optaAAlgunAjut: existeixDeutePagamentLloguer || existeixDeutePagamentHipoteca || selector(state, "ha_perdut_lhabitatge_en_els_ultims_2_anys") ||selector(state, "ha_participat_en_un_proces_de_mediacio"),
