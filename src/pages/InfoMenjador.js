        ...
        <Grid container className="container-family">
          ...
          <Grid item sm={12} className="Main">
            ...
            <p>
              ...
              el cost del servei) a l'alumnat que pertany a famílies en situacions
              socioeconòmiques desafavorides. Els destinataris són l'alumnat de
              P-3 a 4t d'ESO escolaritzat en centres públics i concertats, de
              famílies amb ingressos baixos.
            </p>
            <p>
              Per sol·licitar un ajut, les famílies s'han d'adreçar al Consorci
              d’Educació de Barcelona si els alumnes estan escolaritzats en
              centres de la ciutat de Barcelona o als consells comarcals en cas de
              tractar-se de centres de fora de Barcelona.
            </p>
            <h2>Enllaços</h2>
            <ul>
              <li>
