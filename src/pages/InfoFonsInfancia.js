    ...
    return (
        <Grid container className='container-family'>
          ...
          <Grid item sm={12} className='Main'>
            ...
            <p>
              És una targeta moneder creada per l’Ajuntament de Barcelona per
              cobrir les necessitats bàsiques d’infants de 0 a 16 anys. L'import
              és de 100€ mensuals per fill/a fins a un màxim de 900€ anuals per
              infant. En el cas de les famílies monoparentals que siguin
              perceptores d'aquest fons, s’afegeix un ajut complementari de
              900€/any.
            </p>
            <p>
              Els destinataris són tots els infants menors de 16 anys empadronats
